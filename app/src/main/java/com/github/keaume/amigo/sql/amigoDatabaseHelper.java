...
public class amigoDatabaseHelper extends SQLiteOpenHelper {

    private static amigoDatabaseHelper instance;

    public static final String DB_FILE_NAME = "amigo.db";
    ...
    public static synchronized amigoDatabaseHelper getInstance(Context context) {
        if (instance == null) {
            instance = new amigoDatabaseHelper(context.getApplicationContext());
        }
        return instance;
    }

    private amigoDatabaseHelper(Context context) {

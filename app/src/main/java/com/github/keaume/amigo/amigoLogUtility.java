...
public final class amigoLogUtility implements Thread.UncaughtExceptionHandler {
    ...
    public static void saveLogToExternalStorage() {
        ...
        writeFileToExternalStorage("amigo " + iso8601DateFormat.format(new Date()) + ".log", getLog());
    }
    ...
    private static void saveStacktraceToExternalStorage(Throwable ex) {
        ...
        writeFileToExternalStorage("amigo " + iso8601DateFormat.format(new Date()) + ".stacktrace", stackTrace.toString());
    }
}
